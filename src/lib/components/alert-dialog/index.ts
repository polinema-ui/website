...
export { Action, Action as AlertDialogAction, Cancel, Cancel as AlertDialogCancel, Content, Content as AlertDialogContent, Description, Description as AlertDialogDescription, Footer, Footer as AlertDialogFooter, Header, Header as AlertDialogHeader, Media, Media as AlertDialogMedia, Overlay, Overlay as AlertDialogOverlay, Portal, Portal as AlertDialogPortal, Root, Root as AlertDialog, Title, Title as AlertDialogTitle, Trigger, Trigger as AlertDialogTrigger };