...
export const NAV_LINK_ACTIVE = "bg-black/6 text-neutral-900";
export const NAV_LINK_IDLE = "text-neutral-600 hover:bg-black/4 hover:text-neutral-900";

export const ICON_BUTTON_CLASS =
	"flex h-9 w-9 items-center justify-center rounded-lg border border-neutral-200 bg-white text-neutral-700 transition-all hover:bg-neutral-100 hover:text-neutral-900 active:scale-95";

export const DROPDOWN_CONTENT_CLASS = "z-50 min-w-36 rounded-xl border border-neutral-200/80 bg-white p-1 shadow-xl";
