...
export const CARD_META_CLASSES = "text-[13px] text-neutral-400";
export const CARD_TITLE_CLASSES = "text-xl leading-tight font-bold tracking-tight text-white";
export const CARD_SUBTITLE_CLASSES = "mt-1 text-sm text-neutral-400";
export const CARD_DESC_CLASSES = "mt-3 line-clamp-2 text-sm leading-relaxed text-neutral-400";
export const CARD_TAG_CLASSES = "rounded-md bg-white/10 px-2.5 py-1 text-xs font-medium text-neutral-200";
export const CARD_SALARY_CLASSES = "text-lg font-bold text-white";
export const CARD_SALARY_SUFFIX_CLASSES = "text-xs font-normal text-neutral-400";
export const CARD_APPLICANTS_CLASSES = "text-xs text-neutral-400";
export const CARD_MATCH_VALUE_CLASSES = "text-sm font-bold text-emerald-400";
export const CARD_MATCH_LABEL_CLASSES = "text-xs text-neutral-400";
...
export const LOGIN_LOGO_CLASSES = "flex size-11 items-center justify-center overflow-hidden rounded-xl bg-white/5";
export const LOGIN_TITLE_CLASSES = "mt-4 text-xl font-bold tracking-tight text-white";
export const LOGIN_SUBTITLE_CLASSES = "mt-1 text-sm text-neutral-400";
export const LOGIN_LABEL_CLASSES = "mb-1.5 block text-[13px] font-medium text-neutral-300";
...
export const LOGIN_FOOTER_CLASSES = "mt-4 text-center text-[13px] text-neutral-400";
export const LOGIN_LINK_CLASSES = "font-medium text-blue-400 hover:underline";
...
export const IMAGE_TITLE_CLASSES = "mt-3 text-lg leading-snug font-bold tracking-tight text-white";
export const IMAGE_DESC_CLASSES = "mt-2 line-clamp-2 text-sm leading-relaxed text-neutral-400";
export const IMAGE_FOOTER_CLASSES = "mt-4 flex items-center justify-between border-t border-white/10 pt-4";
export const IMAGE_AUTHOR_CLASSES = "text-[13px] font-medium text-neutral-300";
export const IMAGE_DATE_CLASSES = "mt-0.5 text-xs text-neutral-500";

export const SCHEDULED_CARD_CLASSES =
	"w-full max-w-md rounded-2xl border border-white/10 bg-neutral-950 p-5 text-neutral-100 shadow-[0_8px_30px_rgba(0,0,0,0.35)]";
export const SCHEDULED_TITLE_CLASSES = "text-lg font-bold tracking-tight text-white";
export const SCHEDULED_SUBTITLE_CLASSES = "mt-0.5 text-[13px] text-neutral-400";
export const SCHEDULED_ROW_CLASSES = "flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-3";
export const SCHEDULED_ROW_NAME_CLASSES = "text-sm font-medium text-white";
export const SCHEDULED_ROW_META_CLASSES = "mt-0.5 flex items-center gap-1.5 text-xs text-neutral-400";
export const SCHEDULED_STATUS_ACTIVE_CLASSES = "size-2 shrink-0 rounded-full bg-emerald-400";
export const SCHEDULED_STATUS_IDLE_CLASSES = "size-2 shrink-0 rounded-full bg-neutral-600";
